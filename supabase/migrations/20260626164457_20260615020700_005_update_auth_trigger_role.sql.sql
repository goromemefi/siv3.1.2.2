/*
# Update Auth Trigger Default Role

1. Changes
- Update default role to 'store_customer' (valid value from constraint)
- Handle 'super_admin' role properly

2. Role constraints
Valid roles: super_admin, manager, sales_executive, inventory_manager, accountant, delivery_staff, customer_portal, store_customer
*/
